...
# =================================================
    ...
    - ⚠️ **Data Quality Issues**: Several product sizes are recorded as “UNKNOWN”, indicating 
       missing data.More than  50% of revenue records contain zerovalues, which significantly 
       reduces the reliability and accuracy of sales and performance analysis.
    ...
    - 🏢 **Regional Focus**:  
      Prioritize Delhi, Kolkata, and Mumbai with localized promotions and supply chain support.Investigate 
    ...
    - 🧹 **Data Quality Improvement**:  
       Define validation criteria to reduce missing or incorrect entries in the future. by implementing
       stronge data entry workflows (such as mandatory fields). 
    """)
